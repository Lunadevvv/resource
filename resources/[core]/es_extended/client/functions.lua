...
function ESX.ShowNotification(message, type, length)
    if GetResourceState("esx_notify") ~= "missing" then
        return exports["notify"]:Alert("Hệ thống", message, length, type)
    end
...
function ESX.ShowAdvancedNotification(sender, subject, msg, textureDict, iconType, flash, saveToBrief, hudColorIndex)
    ...
    AddTextEntry('esxAdvancedNotification', "<FONT FACE='Baloo Paaji 2 SemiBold'>"..msg.."</FONT>")
...
function ESX.ShowHelpNotification(msg, thisFrame, beep, duration)
    AddTextEntry('esxHelpNotification', "<FONT FACE='Baloo Paaji 2 SemiBold'>"..msg.."</FONT>")
...
function ESX.ShowFloatingHelpNotification(msg, coords)
    AddTextEntry('esxFloatingHelpNotification', "<FONT FACE='Baloo Paaji 2 SemiBold'>"..msg.."</FONT>")
...
AddEventHandler('esx:showNotification', function(msg, type, length)
    ESX.ShowNotification("Hệ Thống", msg, type, length)
end)
...
CreateThread(function()
	...
	ESX.FontId = RegisterFontId('Baloo Paaji 2 SemiBold')
...
ESX.NumJobs = {police = 0, mechanic = 0, ambulance = 0, player = player}
ESX.NumPolice_CL = function()
	return ESX.NumJobs.police
end 
ESX.NumAmbulance_CL = function()
	return ESX.NumJobs.ambulance
end
ESX.NumMechanic_CL = function()
	return ESX.NumJobs.mechanic
end
ESX.NumPlayer_CL = function()
	return ESX.NumJobs.player
end

RegisterNetEvent('esx:NumJobs')
AddEventHandler('esx:NumJobs', function(dem)
	ESX.NumJobs = dem
end)