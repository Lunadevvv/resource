...
-- function ESX.AddCoinLock(xPlayer, amount)
--   MySQL.prepare(
...
ESX.NumJob = {police = 0, mechanic = 0, ambulance = 0, player = player}
ESX.NumPlayer_SV = function()
	return ESX.NumJob.player
end
ESX.NumPolice_SV = function()
	return ESX.NumJob.police
end
ESX.NumAmbulance_SV = function()
	return ESX.NumJob.ambulance
end
ESX.NumMechanic_SV = function()
	return ESX.NumJob.mechanic
end
Citizen.CreateThread(function()
	while true do	
		local player,pol,ambu,mecha = 0,0,0,0
		...
		for i=1, #xPlayers, 1 do
			...
			elseif xPlayer.job.name == 'mechanic' then 	
				mecha = mecha +1
			-- elseif xPlayer.job.name == 'army' then 	
			-- 	arm = arm +1
			end
		end
		ESX.NumJob = {police = pol, mechanic = mecha, ambulance = ambu, player = player}
		TriggerClientEvent('esx:NumJobs',-1,ESX.NumJob)
		TriggerClientEvent('esx:playernum', -1, player)
		Citizen.Wait(60000)
	end
end)