...
ESX.RegisterCommand('addcoinlock', 'admin', function(xPlayer, args, showError)
	args.playerId.AddCoinLock(args.amount)
end, false, {help = 'addcoinlock', validate = true, arguments = {
	{name = 'playerId', help = 'id người chơi', type = 'player'},
	{name = 'amount', help = 'coin', type = 'number'}
}})

ESX.RegisterCommand('setcoinlock', 'admin', function(xPlayer, args, showError)
	args.playerId.SetCoinLock(args.amount)
end, false, {help = 'setcoinlock', validate = true, arguments = {
	{name = 'playerId', help = 'id người chơi', type = 'player'},
	{name = 'amount', help = 'coin', type = 'number'}
}})

ESX.RegisterCommand('delcoinlock', 'admin', function(xPlayer, args, showError)
	args.playerId.DelCoinLock(args.amount)
end, false, {help = 'delcoinlock', validate = true, arguments = {
	{name = 'playerId', help = 'id người chơi', type = 'player'},
	{name = 'amount', help = 'coin', type = 'number'}
}})

ESX.RegisterCommand('addcoin', 'admin', function(xPlayer, args, showError)
	args.playerId.AddCoin(args.amount)
end, false, {help = 'addcoin', validate = true, arguments = {
	{name = 'playerId', help = 'id người chơi', type = 'player'},
	{name = 'amount', help = 'coin', type = 'number'}
}})

ESX.RegisterCommand('setcoin', 'admin', function(xPlayer, args, showError)
	args.playerId.SetCoin(args.amount)
end, false, {help = 'setcoin', validate = true, arguments = {
	{name = 'playerId', help = 'id người chơi', type = 'player'},
	{name = 'amount', help = 'coin', type = 'number'}
}})

ESX.RegisterCommand('delcoin', 'admin', function(xPlayer, args, showError)
	args.playerId.DelCoin(args.amount)
end, false, {help = 'delcoin', validate = true, arguments = {
	{name = 'playerId', help = 'id người chơi', type = 'player'},
	{name = 'amount', help = 'coin', type = 'number'}
}})
