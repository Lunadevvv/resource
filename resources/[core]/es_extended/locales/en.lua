Locales['en'] = {
  ...
  ['noammo'] = "Hết Mẹ Đạn RỒi",
  ['gave_item'] = "ĐƯa %sx %s cho %s",
  ['received_item'] = "Nhận  %sx %s Từ %s ",
  ['gave_weapon'] = "Đưa  %s vũ khí %s ",
  ['gave_weapon_ammo'] = "Đưa  ~o~%sx %s Đạn %s to %s",
  ['gave_weapon_withammo'] = "đưa vũ khí   %s kèm  ~o~%sx %s tới  %s",
  ['gave_weapon_hasalready'] = "%s đưa vũ khí đã nạp đạn  %s",
  ['gave_weapon_noweapon'] = "%s Không nhận được vũ khí ",
  ['received_weapon'] = "Đã Nhận  %s Từ  %s",
  ['received_weapon_ammo'] = "Đã Nhận  ~o~%sx %s Được đạn  %s Từ  %s",
  ['received_weapon_withammo'] = "Đã NHận Vũ khí  %s kèm  ~o~%sx %s Từ  %s",
  ['received_weapon_hasalready'] = " Kho Đồ Đầy ",
  ['received_weapon_noweapon'] = " Không đủ Nguyên Liệu cung cấp ",
  ['gave_account_money'] = "ĐƯA  $%s (%s) Cho  %s ",
  ['received_account_money'] = " Nhận  $%s (%s) Từ %s",
  ['amount_invalid'] = " Số Lượng Không Hợp Lệ ",
  ['players_nearby'] = "Không Có Người Chơi Ở Gần ",
  ['ex_inv_lim'] = "Vượt Quá trọng lượng tối đa %s",
  ['imp_invalid_quantity'] = " Số Lượng Không Hợp Lệ",
  ['imp_invalid_amount'] = " Số Lượng Không Hợp Lệ",
  ['threw_standard'] = "Ném  %sx %s",
  ['threw_account'] = " Ném  $%s %s",
  ['threw_weapon'] = " Ném  %s",
  ['threw_weapon_ammo'] = "Vứt  %s Cho  ~o~%sx sx",
  ['threw_weapon_already'] = "Bạn Đã Ném Vũ Khí Này",
  ['threw_cannot_pickup'] = " Balo Đầy Vui LÒng kiểm tra lại",
  ['threw_pickup_prompt'] = "Bấm E Để Nhặt ",

  -- Key mapping
  ['keymap_showinventory'] = " Mở Kho Đồ  ",

  -- Salary related
  ['received_salary'] = "Bạn Đã Được trả : $%s",
  ['received_help'] = "Tiền trợ cấp : $%s",
  ['company_nomoney'] = " Công Ty Quá Rẻ Rách Không Có Tiền Trả Lương ",
  ['received_paycheck'] = "<FONT FACE='Baloo Paaji 2 SemiBold'>Tiền Về Nè</FONT> ",
  ['bank'] = "VIETCOMBANK",
  ['account_bank'] = "Ngân Hàng ",
  ['account_black_money'] = " Tiền Không Sạch ",
  ['account_money'] = "TIền Mặt ",

  ['act_imp'] = "Không Thể Thực Hiện Hành Động ",
  ['in_vehicle'] = "Không Thể Thực Hiện KHi Đang Trên PHương Tiện",
