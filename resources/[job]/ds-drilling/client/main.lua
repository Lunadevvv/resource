...
function PLATFORM:Init(index, data)
    ...
    --     o:CreateBlip()
    -- end
    -- RegisterNetEvent("ds-drilling:showBlipOil", function()
    --     isShow = not isShow
    --     o:CreateBlip()
    -- end, false)
...
--         RemoveBlip(v)
--     end
--     if Config.UseBlips and isShow then
...
--         table.insert(self.blips, self.blip)
--     end
-- end

Citizen.CreateThread(function()
    local blip = AddBlipForCoord(1562.624, -1820.3209, 90.5457)
