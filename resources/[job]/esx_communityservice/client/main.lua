...
Citizen.CreateThread(function()
	...
	TriggerServerEvent('luna:checkIfSentenced')
end)
...
RegisterNetEvent('luna:inCommunityService')
AddEventHandler('luna:inCommunityService', function(actions_remaining)
	...
	TriggerServerEvent('luna:finishCommunityService', -1)
...
RegisterNetEvent('luna:finishCommunityService')
AddEventHandler('luna:finishCommunityService', function(source)
	local playerPed = PlayerPedId()
			...
			for i = 1, #availableActions do
				...
				if distance < 1.5 then
					...
					if(IsControlJustReleased(1, 38))then
						...
						TriggerServerEvent('luna:completeService')
