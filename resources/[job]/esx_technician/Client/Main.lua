				...
				Citizen.CreateThread(function()
					...
					while not HasModelLoaded(VehicleHash) do
						...
						if TimeWaited >= 5000 then
							ESX.ShowNotification(Config.TranslationList[Config.Translation]["GARAGE_PROBLEM"], 'success', 3999)
							break
						end
					end
	...
	function(Data, MenuMenu) -- Selection
		if Data.current.value == "new_job" then
			if CurrentJob == nil then
				...
				ESX.ShowNotification(Config.TranslationList[Config.Translation]["MENU_CREATED"], 'success', 3999)
			else
				ESX.ShowNotification(Config.TranslationList[Config.Translation]["MENU_ALREADY"], 'success', 3999)
			end
		elseif Data.current.value == "cancel_job" then
			if CurrentJob ~= {} then
				...
				ESX.ShowNotification(Config.TranslationList[Config.Translation]["MENU_CANCELED"], 'success', 3999)
			else
				ESX.ShowNotification(Config.TranslationList[Config.Translation]["MENU_NONE"], 'success', 3999)
			end
		end
