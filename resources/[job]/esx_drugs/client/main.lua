...
local blipRadius = AddBlipForRadius(16.34, 6875.94, 12.64, 200.0)
SetBlipHighDetail(blipRadius, true) 
SetBlipColour(blipRadius, 1) 
SetBlipAlpha (blipRadius, 128)

local blipRadius2 = AddBlipForRadius(315.639557, 4325.367, 48.438, 200.0)
SetBlipHighDetail(blipRadius2, true) 
SetBlipColour(blipRadius2, 1) 
SetBlipAlpha (blipRadius2, 128)