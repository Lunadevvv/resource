...
---------------------------POSTAL-------------------------------------------------------------------------------------------------
		...
		SendNUIMessage({action = 'update', type = 'player-count', data = players})
--------------------GLOBAL------------------------------------------------------------------------------------------------------
...
--------------------------------------------AMMO-------------------------------------------------------------------------------
		...
		--   SendNUIMessage({action = 'update', type = 'weapon-info', data = ammoClip.."/ "..ammoRemaining})	
		  SendNUIMessage({action = 'update', type = 'weapon-info', data = ammoClip})				  
	    else
...
AddEventHandler('rw_hud:setInfo', function(info)
    ...
    SendNUIMessage({action = 'update', type = 'donate-coins', data = info['coin'] or 'ERORR_1'})
	SendNUIMessage({action = 'update', type = 'postal-id', data = info['clock'] or 'ERORR_1'})
