...
AddEventHandler('skinchanger:modelLoaded', function()
	ESX.TriggerServerCallback('esx_tattooshop:requestPlayerTattoos', function(tattooList)
		if tattooList ~= nil or tattooList ~= {} then
		    if tattooList then
...
function OpenShopMenu()
	...
	table.insert(elements, {label= 'Xóa hình xăm', value = 'xoaxam'})
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'tattoo_shop', {
		...
		if data.current.value == 'xoaxam' then
			TriggerServerEvent("esx_tattooshop:xoaxam")
