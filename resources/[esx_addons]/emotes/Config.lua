...
Config.Languages = {
  ['en'] = {
        ['emotes'] = 'Hình ảnh động ~p~ +105 Emotes mới',
        ['danceemotes'] = "🕺 Khiêu vũ",
        ['propemotes'] = "📦 Prop emotes",
        ['favoriteemotes'] = "🌟 Yêu thích",
        ['favoriteinfo'] = "Chọn một Emote ở đây để đặt nó làm yêu thích của bạn.",
        ['rfavorite'] = "Đặt lại yêu thích",
        ['prop2info'] = "❓ Prop Emotes có thể được đặt ở cuối",
        ['set'] = "Đặt (",
        ['setboundemote'] = ") để trở thành Emote ràng buộc của bạn?",
        ['newsetemote'] = "~w~ bây giờ là emote bị ràng buộc của bạn, nhấn ~g~CapsLock~w~ để dùng nó.",
        ['cancelemote'] = "Hủy Emote",
        ['cancelemoteinfo'] = "~r~X~w~ Hủy bỏ Emote hiện đang chơi",
        ['walkingstyles'] = "Phong cách đi bộ",
        ['resetdef'] = "Đặt lại về mặc định",
        ['normalreset'] = "Bình thường (Reset)",
        ['moods'] = "Tâm trạng",
        ['infoupdate'] = "Thông tin",
        ['infoupdateav'] = "Thông tin (Cập nhật có sẵn)",
        ['infoupdateavtext'] = "Một bản cập nhật có sẵn, nhận phiên bản mới nhất từ ~y~https://github.com/andristum/dpemotes~w~",
        ['suggestions'] = "~p~Cảm ơn Dream Town ❤️",
        ['suggestionsinfo'] = "~p~ Cảm ơn Dream Town ❤️",
        ['notvaliddance'] = "không phải là một điệu nhảy hợp lệ.",
        ['notvalidemote'] = "không phải là một Emote hợp lệ.",
        ['nocancel'] = "Không có Emote để hủy bỏ.",
        ['maleonly'] = "Emote này chỉ là nam giới, xin lỗi!",
        ['emotemenucmd'] = "Làm /emotemenu cho một menu.",
        ['shareemotes'] = "👫 Emotes chia sẻ",
        ['shareemotesinfo'] = "Mời một người gần đó phát ra",
        ['sharedanceemotes'] = "🕺 Các điệu nhảy chia sẻ",
        ['notvalidsharedemote'] = "không phải là một Emote được chia sẻ hợp lệ.",
        ['sentrequestto'] = "Đã gửi yêu cầu đến ~y~",
        ['nobodyclose'] = "Không ai ~r~close~w~ đầy đủ.",
        ['doyouwanna'] = "~y~Y~w~ chấp nhận, ~r~L~w~ từ chối (~g~",
        ['refuseemote'] = "Emote từ chối.",
        ['makenearby'] = "làm cho người chơi gần đó chơi",
        ['camera'] = "Nhấn ~y~G~w~ Để sử dụng đèn flash camera.",
        ['makeitrain'] = "Nhấn ~y~G~w~ để làm cho trời mưa.",
        ['pee'] = "Tổ chức ~y~G~w~ đi tiểu.",
        ['spraychamp'] = "Tổ chức ~y~G~w~ để phun rượu sâm banh",
        ['bound'] = "Ràng buộc ",
        ['to'] = "đến",
        ['currentlyboundemotes'] = " Hiện đang bị ràng buộc:",
